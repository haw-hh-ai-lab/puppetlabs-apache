...
class apache::params inherits ::apache::version {
  ...
  if $::osfamily == 'RedHat' or $::operatingsystem == 'amazon' {
    ...
    $default_ssl_cert = "${httpd_dir}/ssl.crt/snakeout-rsa.crt"
    $default_ssl_key  = "${httpd_dir}/ssl.key/snakeout-rsa.key"
    $ssl_certs_dir    = "${httpd_dir}/ssl.crt"
    $passenger_conf_file = 'passenger.conf'
    $passenger_conf_package_file = undef
    $passenger_root   = '/usr'
    $passenger_ruby   = '/usr/bin/ruby'
    ...
    $mod_packages     = {
      ...
      'rpaf'        => 'apache2-mod_rpaf',
      'suphp'       => 'apache2-mod_suphp',
